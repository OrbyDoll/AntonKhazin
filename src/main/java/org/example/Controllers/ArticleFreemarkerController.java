  ...
  private void getAllArticles() {
    service.get(
        ...
        (Request request, Response response) -> {
          ...
          List<Map<String, String>> articlesMapList = articles.stream().map(
              article -> Map.of("title", article.getArticleName(), "count",
                  String.valueOf(article.getComments().size()))).toList();
          Map<String, Object> model = new HashMap<>();
          model.put("articles", articlesMapList);
